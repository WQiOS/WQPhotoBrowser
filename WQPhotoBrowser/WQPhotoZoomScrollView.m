...
- (void)creatPromptView:(NSString *)title {
    ...
    UILabel *promptLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, frame.size.width+34, frame.size.height+24)];
    promptLabel.center = CGPointMake( [UIScreen mainScreen].bounds.size.width/2,  [UIScreen mainScreen].bounds.size.height/2 + 20);
