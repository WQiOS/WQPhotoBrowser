...
@interface WQPhotoGestureHandle () <UIGestureRecognizerDelegate>
...
@implementation WQPhotoGestureHandle
...
- (void)interactiveTransitionRecognizerAction:(UIPanGestureRecognizer *)gestureRecognizer {
    ...
    WQPhotoZoomScrollView *zoomView = [self.delegate currentDetailImageViewInPhotoPreview:self];
